...
The text control codes are somewhat complex.
Archive: CPK
Images: Timg
Text: MSBT
...
The most challenging part of the reverse engineering was modifying the CPK variant, which involved consulting a lot of references. Later, decompression, compression, and repacking of that format were completed, although byte-level alignment could not be achieved.
